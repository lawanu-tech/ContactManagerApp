...
import com.antwebapp.cmapp.command.LoginCommand;
import com.antwebapp.cmapp.command.UserCommand;
...
public class UserController {
    ...
    public String index(Model m) {
    	System.out.println("Inside String Index Funct");
    ...
    public String handleLogin(@ModelAttribute("command") LoginCommand cmd, Model m, HttpSession session) {
        System.out.println("Inside LoginCommand i.e Handle Login");
